...
- (void)updateGraph {
    ...
    NSArray *(^ProducePointsA)() = ^() {
        ...
        NSArray *points = [WYLineChartPoint pointsFromValueArray:@[@(70706.89),@(40446.85),@(50555.67),@(20216.48),@(60664.45),@(80890.34),@(30321.2),@(30321.2),@(30321.2),@(30321.2),@(30321.2),@(30321.2),@(30321.2)]];
